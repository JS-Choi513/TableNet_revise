...
xception_ = keras.applications.xception.Xception(
    include_top=False,
    weights="imagenet",
    input_tensor=input_,
    input_shape=None,
...
for layer in xception_.layers:
    print("fixed!")    
    layer.trainable = False
    layer._name = layer.name+str("_X")# VGG19 layer name collision
...
conv_1_1_1 = Conv2D(filters=128, kernel_size=(1, 1), activation='relu', name="block6_conv1", kernel_regularizer=tf.keras.regularizers.l2(0.004))(xception_.output)
...
plt.savefig("tablenet_xception+VGG10_100epoch_loss.png")
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig("tablenet_xception+VGG10_100epoch_F1.png")



model.save('model/tablenet_xception_VGG19_100')
